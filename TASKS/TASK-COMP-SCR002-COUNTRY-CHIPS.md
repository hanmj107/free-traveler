...
- **TASKS/00_TASK_LIST.md 참조:** Seq 18

## Context

이 Task는 `TASKS/00_TASK_LIST.md`(Seq 18)에 정의된 구현 Task를 실제로 개발 가능한 단위로 상세화한 것이다. 방문 국가 Chip(30개국, 4권역)은(는) SCR-002(`/about`)에서 사용되며, `docs/06_SRS_UIUX_REVISED.md`가 확정한 Screen/Route 배치를 따른다.
...
- `src/components/scr002/CountryChips.tsx`

## Functional AC

아시아/유럽/북미/오세아니아 4권역, **최소 30개국** Chip, 선택 시 관련 여행지/기록으로 이동
...
- **TC-01:** 아시아/유럽/북미/오세아니아 4권역 여부를 확인한다.
- **TC-02:** **최소 30개국** Chip 여부를 확인한다.
- **TC-03:** 선택 시 관련 여행지/기록으로 이동 여부를 확인한다.
