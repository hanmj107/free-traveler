...
- **TASKS/00_TASK_LIST.md 참조:** Seq 19

## Context

이 Task는 `TASKS/00_TASK_LIST.md`(Seq 19)에 정의된 구현 Task를 실제로 개발 가능한 단위로 상세화한 것이다. 여행 사진 Gallery 8장 이상은(는) SCR-002(`/about`)에서 사용되며, `docs/06_SRS_UIUX_REVISED.md`가 확정한 Screen/Route 배치를 따른다.
...
- `src/components/scr002/PhotoGallery.tsx`

## Functional AC

**최소 8장**, 각 사진 alt 텍스트+촬영시기+출처 캡션 필수
...
- **TC-01:** **최소 8장** 여부를 확인한다.
- **TC-02:** 각 사진 alt 텍스트+촬영시기+출처 캡션 필수 여부를 확인한다.
